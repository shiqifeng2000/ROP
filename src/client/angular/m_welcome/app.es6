...
define([
  ...
  app.run(['$rootScope', '$state', '$window', '$http', '$location','$mdSidenav', '$cookies', 'ScopeInitializer', ($rootScope, $state, $window, $http, $location, $mdSidenav, $cookies, ScopeInitializer) => {
